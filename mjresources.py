...
def choose(N) -> int: # Recibe una elección de cualquien menú con opciones numericas (parametro: número de opciones)
    while True: # Fuerza que la entrada esté entre las opciones
        try: # Fuerza que la entrada se un número entero
            ...
            if eleccion in range(1, N + 1): # Verifica que la entrada esté en el rango de opciones
                break
